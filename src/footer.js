    ...
    <div className={classes.root}>
      <AppBar position="fixed" color="primary" className={classes.appBar}>
        <Toolbar className={classes.toolbar}>
          ...
          <Button aria-label="GitHub" color="inherit" href="https://github.com/hprabesh/portfolio-site.git" target="_blank"  variant="p"><GitHubIcon className={classes.icon} /></Button>
        </Toolbar>
      </AppBar>
    </div>
  );
