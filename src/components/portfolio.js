...
export default class Portfolio extends Component {
  state={ 
    ...
    titles:[
      "Performance Tracker","Flash Card Application","To Do List App","Manga Manager"
      ], // titles for pop up 
    projectDescription:[
  ...
  slides = [
    {
      key: uuidv4(),
      content: <figure><center><img className="project-carousel" src={PerformanceTracker} alt="1" onClick={()=>this.onButtonClick(0)} /></center><figcaption><center><em>Performance Tracker</em></center></figcaption></figure>
    },
    {
      key: uuidv4(),
      content: <figure><center><img className="project-carousel" src={FlashCard} alt="2" height="40px" onClick={()=>this.onButtonClick(1)} /></center> <figcaption><center><em>FlashCard Application</em></center></figcaption></figure>,
    },
    {
      key: uuidv4(),
      content: <figure><center><img src={ToDoList}  alt="3" className="project-carousel"  onClick={()=>this.onButtonClick(2)} /></center><figcaption><center><em>ToDoList App</em></center></figcaption></figure>
    },
    {
      key: uuidv4(),
      content: <figure><center><img src={MangaManagerPng}  alt="4" className="project-carousel"  onClick={()=>this.onButtonClick(3)} /></center><figcaption><center><em>MANGA Manager</em></center></figcaption></figure>
    },
